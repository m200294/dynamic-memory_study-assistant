"""
SessionEnd hook — extracts transcript and spawns flush.py in the background.

Does NOT call the API. Pure file I/O. Keep under 10s.
"""
...
# Recursion guard: flush.py -> Agent SDK -> Claude Code would fire this hook.
...
def main() -> None:
    ...
    try:
        ...
        logging.info("Spawned flush.py for session %s (%d turns, %d chars)",
